...
const AppLayout: React.FC = () => {
  ...
  if (loading) return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-[#080c14] text-white">
      <div className="w-10 h-10 border-4 border-primary/20 border-t-primary rounded-full animate-spin mb-4"></div>
      <p className="text-slate-400 text-sm font-medium animate-pulse mb-6">Carregando MB Logística...</p>
      <button
...
export default App;
// Deployment trigger: Mon Jan 26 19:25:36 -03 2026
