         ...
         <div className="flex-1 overflow-y-auto px-6 pb-32 scrollbar-hide space-y-8 pt-4 animate-fadeIn">
               ...
               <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                     ...
                     <input type="text"
                        ...
                        aria-label="Digitar ou escanear serial"
                     />
                  </div>
               </div>
            </div>
               ...
               <div className="grid grid-cols-2 gap-3">
                  {['Coletado', 'Ausente', 'Recusado', 'Agendado'].map((res) => (
                     <button
                        ...
                        className={`py-4 rounded-2xl border font-black text-[10px] uppercase tracking-widest transition-all ${selectedResult === res ? 'bg-primary border-primary text-white shadow-xl shadow-primary/20' : 'bg-white/5 border-white/10 text-slate-500'
                           }`}
                     >
                        {res}
                     </button>
            ...
            <div className="space-y-4">
               ...
               <div className="space-y-3">
                  ...
                  <input ref={fileInputRef} type="file" accept="image/*" className="hidden" onChange={handlePhotoSelect} aria-label="Anexar foto" />
                  ...
                  <div className="relative">
                     ...
                     <input type="url"
                        ...
                        onChange={(e) => {
                           ...
                           setHotlinkUrl(value);
                           if (value) { setPhotoFile(null); setPhotoPreview(null); }
                        }}
                        aria-label="Colar link da imagem"
                     />
                  </div>
